...
import { getContractAddress, getContractChainId } from "@/constants/contracts";
...
export default function Home() {
  ...
  const chainId =
    ready && wallets[0]?.chainId
      ? getContractChainId(getChainIdFromCAIP2(wallets[0].chainId))
      : undefined;

  const contractAddress = getContractAddress(chainId, "covenantNFT");
