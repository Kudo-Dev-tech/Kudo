...
export const balanceEvaluator: Evaluator = {
    ...
    handler: async (runtime: IAgentRuntime, message: Memory, state: State) => {
        ...
        // TODO:  Temporary workaround to map USDC to arbitrum address
        goalObj.tokenAddress = addresses[goalObj.token];
        ...
        if (erc20Balance < minBalance) {
            ...
            const responseMsg = {
                ...
                content: {
                    ...
                    text: `Goal: "Repay ${formatUnits(settlementAmount, goalObj.tokenDecimals)} ${goalObj.token} at ${maturityDate.toFormat("dd LLLL yyyy HH:mm z")} for a ${formatUnits(amountToBorrow, goalObj.tokenDecimals)} ${goalObj.token} loan" Token Address: ${goalObj.tokenAddress} Price: ${amountToBorrow.toString()} Settlment Amount: ${settlementAmount.toString()}`,
